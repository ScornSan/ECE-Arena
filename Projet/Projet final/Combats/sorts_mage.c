...
void sort_tremblement_terre(BITMAP *buffer_map, BITMAP * map,BITMAP * cursor, BITMAP *buffer, BITMAP*buffer_pixels, t_joueur* joueur, int i, t_bloc matrice[23][23], int *red_mouse, int * green_mouse, int *blue_mouse, int *ligne_souris,
