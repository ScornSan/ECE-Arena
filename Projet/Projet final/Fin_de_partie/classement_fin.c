...
void classement_fin2(BITMAP * buffer, t_joueur * joueur, int nb_joueurs, int classement[])
{
    ...
    while (!key[KEY_ESC])
    {
        ...
        if (nb_joueurs == 2)
        {
            ...
            textprintf_ex(buffer, font, 80, 110, makecol(0,0,0), -1, "Degats mis : %d", joueur[classement[0]].degatstotal);
            ...
            textprintf_ex(buffer, font, 300, 110, makecol(0,0,0), -1, "Degats mis : %d", joueur[classement[1]].degatstotal);
        ...
        if (nb_joueurs == 3)
        {
            ...
            textprintf_ex(buffer, font, 80, 110, makecol(0,0,0), -1, "Degats mis : %d", joueur[classement[0]].degatstotal);
            textprintf_ex(buffer, font, 80, 120, makecol(0,0,0), -1, "Cases parcourues : %d", joueur[classement[0]].casesparcourues);
            textprintf_ex(buffer, font, 130, 100, makecol(0,0,0), -1, "2eme : Joueur %d, %s", classement[1], joueur[classement[1]].pseudo);
            textprintf_ex(buffer, font, 130, 110, makecol(0,0,0), -1, "Degats mis : %d", joueur[classement[1]].degatstotal);
            textprintf_ex(buffer, font, 130, 120, makecol(0,0,0), -1, "Cases parcourues : %d", joueur[classement[1]].casesparcourues);
            textprintf_ex(buffer, font, 200, 100, makecol(0,0,0), -1, "3eme : Joueur %d, %s", classement[2], joueur[classement[2]].pseudo);
            textprintf_ex(buffer, font, 200, 110, makecol(0,0,0), -1, "Degats mis : %d", joueur[classement[2]].degatstotal);
            textprintf_ex(buffer, font, 200, 120, makecol(0,0,0), -1, "Cases parcourues : %d", joueur[classement[2]].casesparcourues);
        ...
        if (nb_joueurs == 4)
        {
            ...
            textprintf_ex(buffer, font, 200, 110, makecol(0,0,0), -1, "Degats mis : %d", joueur[classement[2]].degatstotal);
            textprintf_ex(buffer, font, 200, 120, makecol(0,0,0), -1, "Cases parcourues : %d", joueur[classement[2]].casesparcourues);
            textprintf_ex(buffer, font, 260, 100, makecol(0,0,0), -1, "4eme : Joueur %d, %s", classement[3], joueur[classement[3]].pseudo);
            textprintf_ex(buffer, font, 260, 110, makecol(0,0,0), -1, "Degats mis : %d", joueur[classement[3]].degatstotal);
            textprintf_ex(buffer, font, 260, 120, makecol(0,0,0), -1, "Cases parcourues : %d", joueur[classement[3]].casesparcourues);
        }
