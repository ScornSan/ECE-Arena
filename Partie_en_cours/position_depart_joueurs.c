...
void condition_positionnement_depart(int *fini, int ligne_souris, int colonne_souris, t_bloc matrice[23][23], t_joueur* joueur, int *choix1, int *choix2, int *choix3, int *choix4, int red_mouse2, int green_mouse2, int blue_mouse2)
{
    if (joueur[0].choix_double)
    {
        ...
        else if (mouse_b&1 && matrice[ligne_souris][colonne_souris].accessible == 1 && matrice[ligne_souris][colonne_souris].occuper == 0 && green_mouse2 == 170 && *choix2 == 0)
        {
            *fini = *fini +1;
            *choix2 = 1;
        ...
        else if (mouse_b&1 && matrice[ligne_souris][colonne_souris].accessible == 1 && matrice[ligne_souris][colonne_souris].occuper == 0 && red_mouse2 == 170 && *choix3 == 0)
        {
            *fini = *fini +1;
            *choix3 = 1;
        ...
        else if (mouse_b&1 && matrice[ligne_souris][colonne_souris].accessible == 1 && matrice[ligne_souris][colonne_souris].occuper == 0 && green_mouse2 == 170 && *choix4 == 0)
        {
            *fini = *fini +1;
            *choix4 = 1;
