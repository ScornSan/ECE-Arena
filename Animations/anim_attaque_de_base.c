...
void animation_attaque_de_base(BITMAP *buffer, BITMAP *bg, t_joueur* j, int i, t_bloc matrice[23][23], int nb_joueurs, int direction, int respiration_joueur[])
{
    ...
    for (int k = 0; k < 10; k++)
    {
        ...
        case 0:
            ...
            draw_sprite(buffer, j[i].classe.anim_attaques[j[i].id_classe - 1][0][num_bitmap], matrice[j[i].x][j[i].y].x_bloc - 22, matrice[j[i].x][j[i].y].y_bloc - 52);
        ...
        case 2:
            ...
            // 3) AFFICHAGE NOUVELLEs POSITIONs SUR LE BUFFER
            draw_sprite(buffer, j[i].classe.anim_attaques[j[i].id_classe - 1][2][num_bitmap], matrice[j[i].x][j[i].y].x_bloc - 22, matrice[j[i].x][j[i].y].y_bloc - 52);
            affichage_joueurs_respiration(buffer, j, i, nb_joueurs, matrice, respiration_joueur, i);
        ...
        case 3:
            ...
            // 3) AFFICHAGE NOUVELLEs POSITIONs SUR LE BUFFER
            draw_sprite(buffer, j[i].classe.anim_attaques[j[i].id_classe - 1][3][num_bitmap], matrice[j[i].x][j[i].y].x_bloc - 22, matrice[j[i].x][j[i].y].y_bloc - 52);
            affichage_joueurs_respiration(buffer, j, i, nb_joueurs, matrice, respiration_joueur, i);
        ...
        case 1:
            ...
            // 3) AFFICHAGE NOUVELLEs POSITIONs SUR LE BUFFER
            draw_sprite(buffer, j[i].classe.anim_attaques[j[i].id_classe - 1][1][num_bitmap], matrice[j[i].x][j[i].y].x_bloc - 22, matrice[j[i].x][j[i].y].y_bloc - 52);
            affichage_joueurs_respiration(buffer, j, i, nb_joueurs, matrice, respiration_joueur, i);
